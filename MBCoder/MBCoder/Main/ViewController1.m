...
- (void)initialize {
    self.tableArray = @[@"生命周期/圆形绘制",@"autoreleasepool、assign、Tagged Pointer",@"线程",@"block",@"copy和指针常量、常量指针",@"layout方法",@"主线程更新UI原因",@"tableview滑动不加载图片1",@"tableview滑动不加载图片2",@"tableview滑动不加载图片3",@"响应者链",@"RunLoop",@"Runtime",@"Cateory和load、initialize",@"多继承、NSProxy",@"KVO",@"时间戳",@"组件化",@"消息机制",@"加载高清大图处理",@"离屏渲染",@"排序查找算法",@"Mach-O文件格式和启动优化",@"https、TCP、socket",@"CoreAnimation",@"Layer",@"CoreGraphics",@"数据库-表之间的关系和查询方式",@"数据库-其他",@"CoreSpotlight",@"UIScrollView",@"关联属性，关联对象",@"新闻详情页",@"GCDObjC",@"模型打印",@"NSLogger",@"RAC",@"MVVM",@"内存管理",@"内联，动态库",@"宏定义",@"旋转缩放平移",@"原子性"];
}
